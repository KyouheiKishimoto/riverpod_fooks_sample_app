...
import 'package:riverpod_fooks_sample_app/shard_preference/user/user_shard_preference.dart';
...
class DiaryPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    UserPreferenceKey.userId.getInt().then((value) => print("userId:" + value.toString()));
    UserPreferenceKey.userName.getString().then((value) => print("userName:" + value.toString()));
